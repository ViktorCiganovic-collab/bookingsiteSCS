    ...
    <Row className="text-center">
      ...
      <section className="aboutSectionTwo py-5">
        <Container>
          ...
          <Row className="text-center">
            <Col md={4}>
              <h5>{t('easy_booking')}</h5>
              <p>{t('easy_booking_desc')}</p>
              <img style={{maxWidth: "100%", borderRadius: "8px"}} src='https://images.pexels.com/photos/17828687/pexels-photo-17828687/free-photo-of-tra-natur-rymden-skrivbord.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2'></img>
            </Col>
            <Col md={4}>
              <h5>{t('secure_data')}</h5>
              <p>{t('secure_data_desc')}</p>
              <img style={{maxWidth: "100%", borderRadius: "8px"}} src='https://images.pexels.com/photos/3747486/pexels-photo-3747486.jpeg?auto=compress&cs=tinysrgb&w=1200'></img>
            </Col>
            <Col md={4}>
              <h5>{t('expert_support')}</h5>
              <p>{t('expert_support_desc')}</p>
              <img style={{maxWidth: "100%", borderRadius: "8px"}} src='https://images.pexels.com/photos/1181271/pexels-photo-1181271.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2'></img>
            </Col>
          </Row>
        </Container>
      </section>
